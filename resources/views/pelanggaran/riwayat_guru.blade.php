...
@section('container')
    <h4><b>Riwayat Pelanggaran Siswa</b></h4>
...
<script>
    function applyDateFilter() {
        ...
        for (var i = 1; i < tr.length; i++) {
            ...
            var dateColumn = td[8].textContent.trim(); // Assuming Tanggal is the 9th column (index 8)

            if (fromDate && toDate) {
                if (dateColumn < fromDate || dateColumn > toDate) {
    ...
    function exportToExcel() {
        ...
        XLSX.writeFile(wb, "riwayat_pelanggaran_siswa.xlsx");
    }
</script>
@endsection
