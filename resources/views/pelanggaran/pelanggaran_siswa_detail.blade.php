...
@section('container')
<div class="row">
    <h4><b> Detail Pelanggaran Siswa</b></h4>
            ...
            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                @foreach ($riwayat_pelanggaran as $siswa)
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('pelanggaran.destroy', ['nips' => $siswaDetail->nips, 'id' => $siswa->id]) }}" method="post" id="deleteForm_{{ $siswa->id }}">
                                @method('delete')
                                @csrf
